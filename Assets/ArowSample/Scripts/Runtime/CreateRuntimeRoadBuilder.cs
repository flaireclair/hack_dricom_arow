...
{
public class CreateRuntimeRoadBuilder : MonoBehaviour
{
    // 仮想グリッドのサイズ
    ...
    public NodeMapHolder CreateRoads(ArowMapObjectModel arowMapObjectModel, OSMDefine.CREATE_WAY key)
    {
        ...
        .SetOnCompletedCreateMeshCallBack((list) =>
        {
            ...
            GameObject parent_obj = CreateRuntimeUtility.GetOrCreateParentInfoFromArowMapObjectModel(arowMapObjectModel).gameObject;
            // 実際のゲームオブジェクト生成を行う.
