...
public class ArowSampleGameMain_RouteSearch : MonoBehaviour
{
    ...
    // 道情報保持クラス
    private MapTracer nodeMapTracer;
    private MapHolder nodeMapHolder;
    ...
    private MapScript arowDemoMain;
    ...
    public void SetupNodeMapTracer()
    {
        ...
        nodeMapTracer = gameObject.GetComponent<MapTracer>();

        if (nodeMapTracer == null)
        {
            nodeMapTracer = gameObject.AddComponent<MapTracer>();
        }
    ...
    private void Initialize()
    {
        ...
        PlayOrderTextObj.SetActive(false);
        arowDemoMain = gameObject.AddComponent<MapScript>();
    }
    /// <summary>
